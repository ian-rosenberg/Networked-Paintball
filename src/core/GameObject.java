...
public abstract class GameObject implements Serializable {
    ...
    /**
     * Set the index of the corresponding team to place the player into.
     * There is no friendly fire, so once a bullet has been fired from anyone
     * on team teamNumber it cannot collide with the same team, only other teams.
     * 
     * @param teamNumber
     */
